...
class DRG_sub:
    ...
    def reduce_net(self, reactions: list, 
        ...
        for idx, reaction in enumerate(reactions):
            ...
            species = species - set(dropped)

            if species.issubset(reached_species):
                reduced_rxns.append(reaction)
                skeletal_rates.append(k[idx])
                reduced_rxns_indices.append(idx)
                skeletal_species.update(species)

        self.skeletal_rates = skeletal_rates
        self.skeletal_species = sorted(skeletal_species)
