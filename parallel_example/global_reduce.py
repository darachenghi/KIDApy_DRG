...
SAVE_DIR = HERE/f"global_{cluster_name}_results" #All results: reduced network, reduced solution, error, and error plots
SAVE_DIR.mkdir(parents=True, exist_ok= True)

RED_NET_DIR =  REPO_ROOT.parent/"results"/"global_reduced_networks"
...
full_ref_file = Path("/scratch/10864/arjunveejay/KIDApy_DRG/parallel_example/results")/f"{cluster_name}_results"/"errors"/"errors_full.csv"
