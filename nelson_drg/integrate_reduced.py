...
network_path = Path("/oden/cheng/Downloads/code/DRG/KIDApy_DRG/nelson_drg/nelson_reduced_net_eps0.2.json")
...
out_root =Path("/oden/cheng/Downloads/code/DRG/KIDApy_DRG/nelson_drg/nelson_reduced_eps0.2")
