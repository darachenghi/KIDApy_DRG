...
files = ["/oden/cheng/Downloads/code/DRG/KIDApy_DRG/kida_drg/epsilon/kida_eps_results_sub.json"]
plt.figure()
...
plt.savefig("/oden/cheng/Downloads/code/DRG/KIDApy_DRG/kida_drg/epsilon/kida_eps")
